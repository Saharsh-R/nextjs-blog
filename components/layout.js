...
const name = "Saharsh Rathi";
export const siteTitle = "Next.js Blog";

export default function Layout({ children, home, ssr }) {
	return (
				...
				{home ? (
					...
					<>
						...
						<div style={{ display: "flex" }}>
							<h2 className={utilStyles.headingLgNavBar}>
								<Link href="/">
							...
							<h2 className={utilStyles.headingLgNavBar}>
								<Link href="/ssr">
									<a className={utilStyles.colorInherit}>SSR</a>
								</Link>
							</h2>
						</div>
					</>
